...
<!DOCTYPE html><html lang="en"><head><meta charset="utf-8">
   ...
   <link rel="stylesheet" href="css/versions.css?v=1">
   <link rel="stylesheet" href="css/responsive.css?v=1">
   <link rel="stylesheet" href="css/custom.css?v=1">
   <script src="js/modernizer.js?v=1"></script>
   ...
   <script>
      var fbp = new URLSearchParams(window.location.search).get('fbp');
      var ggl = new URLSearchParams(window.location.search).get('ggl');
                     ...
                     <form id="contactform1" class="row" name="contactform" method="post">
                        ...
                        <fieldset class="row-fluid">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                onkeyup="this.value = this.value.replace(/[^\+\d]/g, '')" maxlength="13" minlength="5">
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="row">
               ...
               <div class="col-md-3">
                  <div class="agencies_meta clearfix">
                     <span><i class="fa fa-envelope "></i> <a href="/cdn-cgi/l/email-protection#40333530302f323400332934252e212d256e232f2d"><span class="__cf_email__" data-cfemail="e4979194948b9690a4978d90818a858981ca878b89">[email�&nbsp;protected]</span></a></span>
                  ...
                  <div class="contact_form">
                     ...
                     <form id="contactform" class="row" name="contactform" method="post">
                        ...
                        <fieldset class="row-fluid">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <input type="text" name="phone" id="phone" class="form-control" placeholder="Your Phone" onkeyup="this.value = this.value.replace(/[^\+\d]/g, '')" maxlength="13" minlength="5">
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <label class="sr-only">Select Time</label>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                                <button type="submit" value="SEND" id="submit1" class="btn btn-light btn-radius btn-brd grd1 btn-block">Get Appointment</button>
                            </div>
                        </fieldset>
                    </form>
               ...
               <div class="col-md-3 col-sm-3 col-xs-12">
                  <div class="widget clearfix">
                     ...
                     <ul class="footer-links">
                        <li><a href="/cdn-cgi/l/email-protection#f3d0"><span class="__cf_email__" data-cfemail="5d34333b321d2432282f2e342938733e3230">[email�&nbsp;protected]</span></a></li>
...
<div id="successModal" style="display: none;">
   <div>
       <p id="modalMessage"></p>
       <button onclick="$('#successModal').fadeOut();">Закрыть</button>
   </div>
</div>
